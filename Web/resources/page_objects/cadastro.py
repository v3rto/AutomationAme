...
class sign_up(PageObject):
    ...
    def select_state_option(self, state_option):
        ...
        self.selib.wait_until_element_is_visible(self.locator.state_picklist)
    ...
    def click_home_button(self):
        """Click em Home"""
        self.selib.wait_until_element_is_visible(self.locator.home_button)
